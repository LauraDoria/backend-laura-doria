...
HEROKU:
https://git.heroku.com/raw-backend-coderhouse.git
...
*db
    ...
    mongooseCart.js (funciones para manejo de base de datos de carritos de compras con Mongoose)
    mongooseCartControllers.js (clase controladores de carrito de compras)
    mongooseProducts.js (funciones para manejo de base de datos de productos con Mongoose)
    mongooseProductsControllers.js (clase controladores de producto)
*routes
    ...
    logoutRouter.js (ruta post de user, exporta a indexRouter)
    infoRouter.js (ruta get de información de objeto global process, exporta a indexRouter)
    randomRouter.js (ruta get de generador de arrays de números random)
*public
    ...
    *views (html templates)
        ...
        info (página de información acerca de propiedades del objeto global process)
        randoms (página del generador de arrays de números random)
*models
...
*utils
    random.js (child-process del generador de arrays de números aleatorios)
